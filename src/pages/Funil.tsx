    ...
    <div className="p-4 md:p-6">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-white">Funil de Vendas</h1>
            <p className="text-gray-400 mt-1">{opportunities.length} oportunidades</p>
          </div>
          <button onClick={() => setIsModalOpen(true)} className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-stagetek-red text-white rounded-lg hover:bg-stagetek-red-medium transition-all">
